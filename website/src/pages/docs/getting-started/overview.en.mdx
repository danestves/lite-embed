...
**This always comes with a trade-off**: you want to be able to embed videos without having to wait for the video to load, but you also want to be able to embed videos that are already loaded.
